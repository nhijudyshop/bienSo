      ...
      <div className="bg-bg-secondary rounded-xl border border-border p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-bg-card rounded-xl border border-border p-4 text-center">
            ...
            <h3 className="text-sm font-semibold mb-1">QR Code ngân hàng</h3>
            <p className="text-xs text-text-secondary">Quét mã QR từ ứng dụng ngân hàng</p>
          </div>
          <div className="bg-bg-card rounded-xl border border-border p-4 text-center">
            <div className="text-3xl mb-2">💳</div>
            <h3 className="text-sm font-semibold mb-1">QR ví điện tử</h3>
            <p className="text-xs text-text-secondary">Thanh toán qua ví MoMo, ZaloPay...</p>
          </div>
          <div className="bg-bg-card rounded-xl border border-border p-4 text-center">
            <div className="text-3xl mb-2">🏦</div>
            <h3 className="text-sm font-semibold mb-1">Chuyển khoản</h3>
            <p className="text-xs text-text-secondary">Chuyển khoản theo thông tin hiển thị</p>
          </div>
        </div>
      </div>
